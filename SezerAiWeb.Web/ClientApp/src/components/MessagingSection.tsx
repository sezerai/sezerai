...
export function MessagingSection() {
  ...
  return (
    <div className="flex-1 glass rounded-panel-radius p-3 sm:p-4 mac-shadow flex flex-col h-full max-h-[calc(100vh-180px)] sm:max-h-[calc(100vh-160px)] w-full touch-manipulation">
      {/* Header - Fixed */}
      <div className="flex items-center gap-2 mb-1.5 sm:mb-2 flex-shrink-0">
      ...
      {/* Scrollable Content */}
      <div className="flex-1 overflow-y-auto custom-scroll pb-4 min-h-0">
        {/* Phone Input */}
        ...
        <div className="relative mb-1.5 sm:mb-2">
          <textarea
            className="w-full glass-dark border-none rounded-2xl py-2 sm:py-2.5 px-3 sm:px-4 focus:ring-2 focus:ring-primary/20 text-body-sm sm:text-body-md font-body-sm sm:font-body-md resize-none custom-scroll touch-manipulation"
      ...
      <button
        type="button"
        className="w-full py-2 sm:py-2.5 rounded-full font-label-md sm:font-title-sm text-label-md sm:text-title-sm transition-all shadow-lg hover:shadow-xl active:scale-[0.98] min-h-[44px] touch-manipulation flex-shrink-0"
        style={{
