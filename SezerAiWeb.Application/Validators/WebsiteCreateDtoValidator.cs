...
public class WebsiteCreateDtoValidator : AbstractValidator<WebsiteCreateDto>
{
    public WebsiteCreateDtoValidator()
    {
        RuleFor(x => x.Name)
        ...
        RuleFor(x => x.OwnerId)
            .NotEmpty().WithMessage("Website sahibi (Owner) zorunludur");
    }
